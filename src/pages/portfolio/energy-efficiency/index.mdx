...
<Case title="Energy Efficiency">
  <main>
    <section class="text">
      ...
      <p class="lead">I took a project from 0 to 1 in 4 days. I started with a vague definition of the problem and some raw materials and, collaborating with sales, clients and engineers, came up with a fully formed feature that our clients loved.</p>
    ...
    <section class="text">
      <p>I also added an animation to make the score change more fun:</p>
    </section>
    <section class="image">

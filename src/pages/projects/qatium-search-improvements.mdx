...
<Case title="Improvements to Search feature">
    <CaseSummary
      title="Improvements to Search feature"
      client="Qatium, 2025"
      tools="Ideation, sketching, coding (TypeScript, CSS), testing (Jest)"
      tldr="I improved the UX for a feature using as little time as possible, going straight to code once a design decision was made."
    />
    <section class="text">
      ## Problem
    ...
    <section class="text">
      ...
      - The main learning from this project is that **sometimes you have to kill your darlings**. We could have spent a lot of time and effort trying to change the behavior of the feature to match the visual design, but in the end, the simplest solution was to change the visual design to match the behavior. We can always redo a design, but a frustrated user is harder to fix.
      - Another important takeaway is that **being humble pays off** when working in product. We spent too much time thinking "users don't get it yet, but they will eventually" instead of just asking them what they thought. We should have fixed this sooner.
    </section>
</Case>

...
<Case title="Qatium.app UI Redesign">
    ...
    <section class="text">
      ...
      I've been thinking about potential solutions to the more urgent issues in the app UI for a while. So I recently spent some quality time putting these ideas to (virtual) paper, focusing on a few high level changes that our agile process usually overlooks.

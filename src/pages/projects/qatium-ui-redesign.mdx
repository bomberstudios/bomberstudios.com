...
<Case title="Qatium.app UI Redesign">
    ...
    <section class="text">
      ...
      I took a couple of afternoons to go through the more urgent issues in the app UI, focusing on high level changes that our agile process usually overlooks.
